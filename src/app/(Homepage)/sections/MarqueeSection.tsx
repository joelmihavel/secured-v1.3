...
export const MarqueeSection = () => {
        ...
        <>
            {[...Array(8)].map((_, i) => (
                <span key={i} className="text-xl sm:text-2xl md:text-4xl lg:text-fluid-h1 font-heading text-gray-200 tracking-tight">
                    Others connect you to <span className="font-zin-italic">landlords.</span>
                </span>
            ))}
        </>
    );
        ...
        <>
            {[...Array(8)].map((_, i) => (
                <span key={i} className="text-xl sm:text-2xl md:text-4xl lg:text-fluid-h1 font-heading text-brand-yellow tracking-tight">
                    We build and run the <span className="font-zin-italic">entire living experience.</span>
                </span>
            ))}
        </>
    );
    ...
    return (
        <OpenSection className="bg-bg-white py-4 md:py-12">
