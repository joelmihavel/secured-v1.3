    ...
    return (
        <motion.div
            ...
            animate={{
                ...
                backgroundColor: isHovered ? "rgb(243, 244, 246)" : "rgba(243, 244, 246, 0)",
            }}
...
export const PropertyCard = ({
    ...
    const isOccupied = !isComingSoon && !property.fieldData.available && !property.fieldData["available-from"];
    ...
    return (
        <div className={`flex flex-col relative w-full h-full ${isOccupied ? "opacity-60" : ""}`}>
            <div
                className={`group/card rounded-t-[2rem] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col relative bg-white h-full ${isOccupied ? "pointer-events-none" : ""}`}
            ...
            >
                    ...
                    <AnimatePresence initial={false}>
                        ...
                        >
                            <Image
                                ...
                                fill
                                className={`object-cover transition-transform duration-700 ${!isComingSoon ? "group-hover/card:scale-110" : ""
                                    } pointer-events-none`}
                            />
                        </motion.div>
                    </AnimatePresence>
                ...
                <div className="p-4 md:p-6 flex flex-col gap-2 md:gap-3 bg-white flex-grow">
                    ...
                    <div className="flex items-center gap-2 pb-2">
                        ...
                        <ArrowUpRight
                            className="w-6 h-6 shrink-0 opacity-0 -translate-x-2 group-hover/card:opacity-100 group-hover/card:translate-x-0 transition-all duration-300 ease-out text-text-main"
                        />
                    </div>
                    ...
                    {isComingSoon ? (
                        ...
                        <>
                            ...
                            <div className="flex items-center gap-2 text-text-main/80">
                                ...
                                <span className="font-body text-sm md:text-base">
                                    Private Rooms: ₹{parseInt(property.fieldData["rent-in-rupees"] || "0").toLocaleString().replace(/,/g, "").slice(0, -3)}K/mo
                                </span>
                            </div>
                        ...
                        <>
                            ...
                            <div className="flex items-center justify-between text-text-main/80">
                                ...
                                <div className="flex items-center gap-1 md:gap-2">
                                    <Square size={16} className="rotate-45 md:w-[18px] md:h-[18px]" />
                                    <span className="font-body text-xs font-medium">
                                        {property.fieldData["carpet-area"]} Sq. Ft
                                    </span>
                                </div>
                                    ...
                                    {totalRooms > 0 && availableRooms === totalRooms ? (
                                        ...
                                        <span className="font-body text-xs font-medium">
                                            {property.fieldData["property-bedrooms"] === 1
                                                ...
                                                : "You'll be the first occupant, take dibs on the master bedroom."
                                            }
                                        </span>
                                    ) : (
                                    ...
                                    <div className="flex items-center gap-2 overflow-hidden flex-shrink min-w-0">
                                        {companies.length > 0 ? (
                                            companies.slice(0, 3).map((company, idx) => {
                                                const logoFile = Object.entries(companyLogos).find(([key]) =>
