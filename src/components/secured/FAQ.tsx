...
function FAQItem({ question, answer, index }: { question: string; answer: string; index: number }) {
  ...
  return (
    <FadeIn delay={0.05 * index}>
      <div
        className={`rounded-2xl p-6 transition-colors duration-300 md:p-8 ${
          isOpen
            ? "bg-[#cc7b57]"
      ...
      >
        <button
          ...
          className="flex w-full items-center justify-between gap-6 text-left md:gap-8"
        >
          <span
            className={`font-display text-base leading-[1.2] md:text-2xl xl:text-[28px] ${
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div className="pt-4">
                <p
                  className="font-ui text-sm font-medium leading-[1.6] text-[#060606] md:text-base"
                >
    ...
    <section className="bg-[#131313] py-8 md:pb-20 md:pt-[120px]">
      <SectionWrapper>
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          <SlideUp>
            <p
              className="text-sm leading-[1.6] tracking-[-0.32px] text-[#b5b5b5] md:text-base"
              style={{ fontFamily: "var(--font-ui)" }}
            >
              FAQs
            </p>
          </SlideUp>
          <h2 className="font-display text-[28px] leading-[1.4] tracking-[-0.5px] text-white md:text-[40px] md:leading-[1.5] md:tracking-[-0.88px] xl:text-[48px] 2xl:text-[52px]">
        ...
        <div className="mt-8 overflow-hidden rounded-2xl bg-[#202020] p-4 shadow-[0px_78px_47px_0px_rgba(0,0,0,0.05),0px_35px_35px_0px_rgba(0,0,0,0.09),0px_9px_19px_0px_rgba(0,0,0,0.1)] md:mt-16 md:rounded-3xl md:p-8">
          <div className="mb-6 md:mb-10">
            <h3 className="font-display text-[28px] leading-[1.5] text-white md:text-[40px] xl:text-[48px]">
              FAQs.
            </h3>
          </div>
