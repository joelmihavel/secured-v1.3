    ...
    <div ref={sectionRef} data-section="how-it-works" style={{ height: `${STEPS.length * 100}vh` }}>
      ...
      >
        ...
        <div className="flex h-full flex-col">
          ...
          {/* === DESKTOP LAYOUT (lg+) === */}
          <div className="relative z-10 mx-auto hidden h-full w-full px-[200px] lg:flex lg:items-center">
            <div className="flex w-full items-center justify-between gap-16">
              {/* Left — heading */}
              <div className="flex w-[376px] flex-shrink-0 flex-col gap-4 3xl:w-[460px] 4xl:w-[560px] 5xl:w-[760px]">
                <p
                  className="text-base leading-[1.6] tracking-[-0.32px] text-[#999] 3xl:text-lg 4xl:text-xl 5xl:text-2xl"
                  style={{ fontFamily: "var(--font-ui)" }}
                >
                  {data.sectionLabel}
                </p>
