...
export function Footer({ data }: { data: FooterContent }) {
  return (
    <footer className="relative flex flex-col items-center overflow-hidden bg-[#131313] px-6 pb-[140px] pt-8 md:px-16 md:pb-[220px] md:pt-20 lg:px-[120px]">
      ...
      <div className="relative z-10 flex w-full max-w-[600px] flex-col items-center gap-6 md:gap-8 xl:max-w-[700px] 2xl:max-w-[800px]">
        {/* Flent icon */}
        <motion.div
        ...
        >
          <a
            ...
            className="flex w-full items-center justify-center rounded-xl bg-[#202020] px-6 py-4 text-sm leading-5 text-white transition-colors"
            style={{
        ...
        >
          <div className="h-12 w-px bg-[#ff9a6d] md:h-20" />
        ...
        >
          <div className="flex flex-col items-center">
            <span className="font-body text-center text-[28px] leading-[130%] text-[#797979] md:text-[36px] lg:text-[48px] xl:text-[56px] 2xl:text-[64px]">
              {data.taglineLine1}
            </span>
            <span className="font-body text-center text-[28px] leading-[130%] text-[#ff9a6d] md:text-[36px] lg:text-[48px] xl:text-[56px] 2xl:text-[64px]">
              {data.taglineLine2}
            </span>
          </div>
          <p className="font-body text-center text-xs uppercase leading-[18px] tracking-[1px] text-[#5a5a5a] md:text-sm">
            {data.copyright}
          </p>
        </motion.div>
      </div>
